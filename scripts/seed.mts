...
const INSTRUMENT_TREES: Record<string, { slug: string; title: string; tier: number; description: string }[]> = {
  drums: [
    ...
    { slug: "drums-linear", title: "Linear Drumming", tier: 5, description: "Patterns where no two limbs strike together." },
    { slug: "drums-polyrhythm", title: "Polyrhythms & Metric Modulation", tier: 5, description: "3:2 and 4:3, and shifting the felt pulse." },
    { slug: "drums-brushes", title: "Brushes", tier: 5, description: "Jazz brush technique: stirring, slaps, legato sweeps." },
    { slug: "drums-double-bass", title: "Double Bass & Heel-Toe", tier: 5, description: "Fast, even doubles without losing the groove." },
    { slug: "drums-soloing", title: "Soloing & Trading Fours", tier: 6, description: "Structured improvisation that still states the form." },
    { slug: "drums-click-tracking", title: "Playing to a Click & Tracking", tier: 6, description: "Studio-grade time, takes that need no editing." },
    { slug: "drums-genre-authenticity", title: "Genre Authenticity", tier: 6, description: "Samba, songo, second line, drum and bass, played idiomatically." },
  ],
  bass: [
    ...
    { slug: "bass-chordal", title: "Chordal & Double Stops", tier: 5, description: "Tenths, upper structures, filling space without a guitar." },
    { slug: "bass-advanced-slap", title: "Advanced Slap", tier: 5, description: "Double thumbing, ghost-note vocabulary, funk phrasing." },
    { slug: "bass-fretless", title: "Fretless Intonation & Vibrato", tier: 5, description: "Playing in tune with no frets to hide behind." },
    { slug: "bass-odd-meter", title: "Odd Meter Grooves", tier: 5, description: "Locking 5/4 and 7/8 without counting out loud." },
    { slug: "bass-solo-improv", title: "Improvised Solos Over Changes", tier: 6, description: "Melodic soloing that outlines the harmony." },
    { slug: "bass-session-reading", title: "Session Reading", tier: 6, description: "Sight-reading charts on the first take." },
    { slug: "bass-tone-di", title: "Tone Shaping & DI Recording", tier: 6, description: "Getting a finished bass sound to tape." },
  ],
  guitar: [
    ...
    { slug: "guitar-caged-fluency", title: "CAGED Fluency", tier: 5, description: "One shape anywhere on the neck, without hunting." },
    { slug: "guitar-modal-improv", title: "Modal Improvisation", tier: 5, description: "Soloing over static vamps with modal colour." },
    { slug: "guitar-hybrid-picking", title: "Hybrid Picking", tier: 5, description: "Pick and fingers together for country and R&B lines." },
    { slug: "guitar-comping", title: "Comping Behind a Vocal", tier: 5, description: "Rhythm guitar that supports rather than competes." },
    { slug: "guitar-chord-melody", title: "Chord Melody", tier: 6, description: "Melody, harmony and bass at once, unaccompanied." },
    { slug: "guitar-reharm", title: "Reharmonisation on Guitar", tier: 6, description: "Substitutions and passing chords under a known melody." },
    { slug: "guitar-recording-tone", title: "Recording Tone", tier: 6, description: "Amps, pedals and mic placement for a mix-ready sound." },
  ],
  keys: [
    ...
    { slug: "keys-rootless", title: "Rootless Voicings", tier: 5, description: "Bill Evans style A and B voicings in all keys." },
    { slug: "keys-upper-structures", title: "Upper Structure Triads", tier: 5, description: "Triads over dominants for altered colour." },
    { slug: "keys-stride", title: "Stride & Walking Left Hand", tier: 5, description: "Carrying bass and comp with the left hand alone." },
    { slug: "keys-quartal", title: "Quartal & Modal Voicings", tier: 5, description: "Fourths-based voicings for modal and gospel settings." },
    { slug: "keys-solo-arrangement", title: "Solo Piano Arrangement", tier: 6, description: "A whole tune alone: melody, harmony, bass, form." },
    { slug: "keys-standards-improv", title: "Improvising Over Standards", tier: 6, description: "Soloing through rhythm changes and common forms." },
    { slug: "keys-synth-programming", title: "Synth Programming", tier: 6, description: "Building pads and leads from oscillators, not presets." },
  ],
};
...
const LOGIC_TREE = [
  ...
  { slug: "logic-mid-side", title: "Mid/Side Processing", tier: 5, description: "Widening and controlling the stereo field independently." },
  { slug: "logic-sidechain", title: "Sidechain & Ducking", tier: 5, description: "Making space rhythmically instead of with EQ alone." },
  { slug: "logic-flex-pitch", title: "Advanced Vocal Tuning", tier: 5, description: "Flex Pitch by hand, keeping the performance human." },
  { slug: "logic-sampler", title: "Sampler & Quick Sampler", tier: 5, description: "Chopping, mapping and playing your own sources." },
  { slug: "logic-mono-phase", title: "Mixing in Mono & Phase", tier: 5, description: "Catching phase problems a stereo mix hides." },
  { slug: "logic-bus-chain", title: "Mix Bus Chain", tier: 6, description: "Compression and saturation that glue without squashing." },
  { slug: "logic-stem-mastering", title: "Stem Mastering", tier: 6, description: "Mastering from stems when the mix needs the control." },
  { slug: "logic-delivery", title: "Delivery & Loudness", tier: 6, description: "LUFS targets, headroom and formats for each platform." },
  { slug: "logic-reference-workflow", title: "Reference Workflow", tier: 6, description: "Systematically matching tone and level to a reference." },
];
